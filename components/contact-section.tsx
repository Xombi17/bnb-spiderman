...
export default function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-20 bg-spiderman-darkblue z-10">
      {/* Background with gradient - modified for smoother transition from prizes section */}
      ...
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-spiderman-darkblue to-transparent z-0"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div
            ...
            className="bg-spiderman-darkblue/70 p-8 rounded-lg border border-white/10 hover:shadow-lg hover:shadow-spiderman-red/10 transition-all duration-300"
          >
            {!isSubmitted ? (
          ...
          <div
            ...
            className="bg-gradient-to-br from-spiderman-darkblue/80 to-spiderman-darkblue p-8 rounded-lg border border-white/10 hover:shadow-lg hover:shadow-spiderman-red/10 transition-all duration-300"
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/70">bitnbuild2024@example.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-white font-medium mb-1">Event Dates</h4>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-spiderman-red/20 p-3 rounded-full text-spiderman-red hover:bg-spiderman-red/30 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5"
